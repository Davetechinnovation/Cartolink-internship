...
function page() {
  return (
    <div className='border border-gray-300 m-2 overflow-x-auto  '>
        ...
        <div className='p-2' >
          ...
          <div className='px-2'>
            <div className='flex gap-2 items-center pb-3 pt-2 justify-between '>
              <p className='text-[23px] font-semibold ' >General</p>
              ...
              <div className='flex justify-between gap-3 items-center '>
                <div className='flex items-center gap-3 '>
                  ...
                  <div >
                    ...
                    <div>
                      <p className='text-[13px] text-gray-700 max-w-[200px] '>Generate videos with Hailuo, pika, Runway, Luma, and more. </p>
                    </div>
                  </div>
              ...
              <div className='flex justify-between gap-3 items-center '>
                <div className='flex items-center gap-3 '>
                  ...
                  <div >
                    ...
                    <div>
                      <p className='text-[13px] text-gray-700 max-w-[200px] '>Realtime Ai rendering on a canvas. instant feedback loops.</p>
                    </div>
                  </div>
              ...
              <div className='flex justify-between gap-3 items-center '>
                <div className='flex items-center gap-3 '>
                  ...
                  <div >
                    ...
                    <div>
                      <p className='text-[13px] text-gray-700 max-w-[200px] '>Upscale and enhance videos up to 22k.</p>
                    </div>
                  </div>
              ...
              <div className='flex justify-between gap-3 items-center '>
                <div className='flex items-center gap-3 '>
                  ...
                  <div >
                    ...
                    <div>
                      <p className='text-[13px] text-gray-700 max-w-[200px] '>Add objects, change style, or expand photos or generations.</p>
                    </div>
                  </div>
              ...
              <div className='flex justify-between gap-3 items-center '>
                <div className='flex items-center gap-3 '>
                  ...
                  <div >
                    ...
                    <div>
                      <p className='text-[13px] text-gray-700 max-w-[200px] '>Lip sync any video to any audio.</p>
                    </div>
                  </div>
              ...
              <div className='flex justify-between gap-3 items-center '>
                <div className='flex items-center gap-3 '>
                  ...
                  <div >
                    ...
                    <div>
                      <p className='text-[13px] text-gray-700 max-w-[200px] '>Transfer motions to images and animate characters.</p>
                    </div>
                  </div>
