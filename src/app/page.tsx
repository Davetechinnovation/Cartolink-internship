import { ChevronDown, Newspaper, Wallet } from 'lucide-react'
          ...
          <div className='p-2' >
            ...
            <div className='px-2'>
              ...
              <div className='grid md:grid-cols-4 gap-6 sm:gap-x-5 sm:gap-y-4  sm:grid-cols-2 grid-cols-1 sm:pr-5  '>
                ...
                <div className='flex justify-between gap-3 items-center '>
                  <div className='flex items-center gap-3 '>
                    <div className=' bg-[linear-gradient(0deg,#888888_0%,#000000_100%)] w-[30px] h-[30px] flex  justify-center items-center p-4 rounded-[5px]  '>
                      <p><svg width="24" height="24" viewBox="0 0 24 24" className='text-wt' fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.49935 13.0083C4.34395 13.5194 3.94455 13.9195 3.43425 14.075C3.94455 14.2306 4.34395 14.6306 4.49935 15.1417C4.65465 14.6306 5.05405 14.2306 5.56445 14.075C5.05405 13.9195 4.65465 13.5194 4.49935 13.0083Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M16.3704 5.57373C16.215 6.08483 15.8156 6.48493 15.3053 6.64043C15.8156 6.79603 16.215 7.19603 16.3704 7.70713C16.5257 7.19603 16.9251 6.79603 17.4355 6.64043C16.9251 6.48493 16.5257 6.08483 16.3704 5.57373Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M7.82105 18.4485H7.83105" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12.8125 3.69873H12.8025" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><rect x="3.3868" y="5.14091" width="2.5" height="22.0199" rx="1.25" transform="rotate(-44.5361 3.3868 5.14091)" stroke="currentColor" stroke-width="1.5"></rect><path d="M8.4043 11.3093L11.2555 8.50389L20.2713 17.6668C21.046 18.4542 21.0357 19.7204 20.2484 20.4951C19.461 21.2698 18.1947 21.2596 17.42 20.4722L8.4043 11.3093Z" fill="currentColor"></path></svg></p>
                    </div>
                    <div >
                      <div className='flex gap-2 items-center '>
                        <p className='font-semibold text-blk '>Enhancer</p>
                        <button className='bg-blue-800 text-wt text-[12px] py-[1px] px-2 rounded-[8px]'>New</button>
                      </div>
                      <div>
                        <p className='text-[13px] text-gra max-w-[200px] '>Upscale and enhance videos up to 22k.</p>
                      </div>
                    </div>

                  </div>
                  <div>
                    <button className='bg-gray-200 px-4 py-1 rounded-[13px] text-[13px]'>Open</button>
                  </div>
                </div>
                ...
                <div className='flex justify-between gap-3 items-center '>
                  <div className='flex items-center gap-3 '>
                    <div className='  bg-[linear-gradient(0deg,#BBCA91_0%,#3C878F_60%,#07280F_100%)] w-[30px] h-[30px] flex  justify-center items-center p-4 rounded-[5px]  '>
                      <p><svg width="22" height="22" className="text-wt" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16.4998 21.174C15.4998 20.5 14.3718 20 12.9998 20C10.9418 20 9.07179 22.356 6.99979 22C4.92779 21.644 4.22479 18.631 5.49979 17.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10.165 8.40356C10.7043 10.6535 12.5111 12.4106 14.7882 12.8777L6.83049 18.7674C6.60581 18.9339 6.32644 19.0157 6.04426 18.9976C5.76209 18.9795 5.49628 18.8627 5.2962 18.6689L4.34224 17.7427C4.14504 17.5516 4.02487 17.2984 4.00345 17.0288C3.98204 16.7593 4.06079 16.4912 4.22547 16.2731L10.165 8.40356Z" fill="currentColor"></path><circle cx="16.5" cy="6.5" r="5.5" fill="currentColor"></circle></svg></p>
                    </div>
                    <div >
                      <div className='flex gap-2 items-center '>
                        <p className='font-semibold text-blk '>Video Lipsync</p>
                        <button className='bg-blue-800 text-wt text-[12px] py-[1px] px-2 rounded-[8px]'>New</button>
                      </div>
                      <div>
                        <p className='text-[13px] text-gra max-w-[200px] '>Lip sync any video to any audio.</p>
                      </div>
                    </div>
                ...
                <div className='flex justify-between gap-3 items-center '>
                  <div className='flex items-center gap-3 '>
                    <div className='w-[30px] h-[30px] flex  justify-center items-center p-4 rounded-[5px]  '>
                      <p><svg width="52" height="52" viewBox="0 0 24 24" fill="none" className=" text-[#c4c4c5] size-10.5" xmlns="http://www.w3.org/2000/svg"><defs><clipPath id="circleMask"><circle cx="12" cy="12" r="7"></circle></clipPath><linearGradient id="fadeGradient" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="white" stop-opacity="0.6"></stop><stop offset="75%" stop-color="white" stop-opacity="0.15"></stop><stop offset="100%" stop-color="white" stop-opacity="0"></stop></linearGradient></defs><image href="/train.webp" x="5" y="5" width="14" height="14" clip-path="url(#circleMask)"></image><circle cx="12" cy="12" r="6" fill="url(#fadeGradient)"></circle><path d="M16.625 20.1226C14.6815 21.2446 12.3964 21.6219 10.1954 21.1841C7.99441 20.7463 6.02762 19.5232 4.66148 17.7429C3.29534 15.9625 2.62303 13.7462 2.7698 11.5068C2.91658 9.26752 3.87243 7.15792 5.45926 5.57108" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M20.0107 7.48682C21.0289 9.25025 21.4366 11.3004 21.1709 13.3192C20.9051 15.338 19.9806 17.2127 18.5407 18.6526" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M12 2.86182C13.2147 2.86182 14.4176 3.10107 15.5398 3.56593C16.6621 4.03079 17.6818 4.71214 18.5407 5.57108" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M7.375 4.10108C8.07507 3.6969 8.8251 3.38622 9.60592 3.177" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg></p>
                    </div>
                    <div >
                      <div className='flex gap-2 items-center '>
                        <p className='font-semibold text-blk '>Train</p>
                      </div>
                      <div>
                        <p className='text-[13px] text-gra max-w-[200px] '>Generate images with custom  styles in flux and ideogram.</p>
                      </div>
